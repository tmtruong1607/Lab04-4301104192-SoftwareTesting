...
WebUI.setText(findTestObject('Object Repository/Page_UP Portal  HoChiMinh University of Pedagogy/input_Tn ng nhp_ctl00ContentPlaceHolder1ctl_537cb7'), 
    GlobalVariable.Correct_username)
...
WebUI.waitForElementPresent(findTestObject('Page_UP Portal  HoChiMinh University of Pedagogy/span_THNG BAO SINH VIN'), 30)

WebUI.verifyElementText(findTestObject('Object Repository/Page_UP Portal  HoChiMinh University of Pedagogy/span_THNG BAO SINH VIN'), 
